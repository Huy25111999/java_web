...
@ModelData(collection = "UserAdmin", mapCacheName = "UserAdmin", mapCacheTTL = HazelcastTTL.TTL_1_DAY)
public class UserAdmin implements Serializable {
    ...
    public UserAdmin(String username, String email, String password, int role) {
    ...
    public UserAdmin(String email, String password,int role) {
        Date now = DateUtil.now();
        this.id = StringUtil.getTimeUUIDString();
        this.email = email;
        this.password = UserHelper.hashPassword(password);
